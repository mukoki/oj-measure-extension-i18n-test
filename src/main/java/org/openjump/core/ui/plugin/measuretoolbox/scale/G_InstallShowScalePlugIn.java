 ...
 *
 * @author sstein
 * (Copy to work with modified scale classes - Giuseppe Aruta. sept 1th 2015)
 */
public class G_InstallShowScalePlugIn extends InstallRendererPlugIn {

  public G_InstallShowScalePlugIn() {
    super(GeoShowScaleRenderer.CONTENT_ID, true);
  }
  ...
  protected Renderer.Factory createFactory(final TaskFrame frame) {
    return new Renderer.Factory() {
      ...
      public Renderer create() {
        return new GeoShowScaleRenderer(frame.getLayerViewPanel());
      }
    };
  }
}